...
(function(exports, module, define) {
  ...
  validate.exposeModule(validate, this, exports, module, __webpack_require__(16));
}).call(this,
...
function validateForm(form) {
  var errorMap = validate(form, constraints);
  ...
  if (validate.contains(form.animal, 'tiger')) {
    var tigerTypeError = validate(form, { tiger_type: { presence: true } });
...
module.exports = { constraints: constraints, validateForm: validateForm };
...
function applyClass(errorMap) {
  if (Object.keys(errorMap).length !== 0) {
    Object.entries(errorMap).forEach(function (_ref3) {
...
function onSubmit(event) {
  ...
  var colourInput = document.getElementsByName('colour')[0];

  var form = {
    email: document.getElementsByName('email')[0].value,
    password: document.getElementsByName('password')[0].value,
    colour: colourInput.options[colourInput.selectedIndex].value,
    animal: [].filter.call(document.getElementsByName('animal'), function (animal) {
  ...
  resetClass(form);
  var errorMap = app.validateForm(form);
